...
import com.example.android.trackmysleepquality.databinding.FragmentTodoTaskBinding
...
class TodoTaskFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val viewModelFactory = TodoTaskViewModelFactory(arguments.sleepNightKey, dataSource)
        ...
        sleepQualityViewModel.navigateToSleepTracker.observe(viewLifecycleOwner, Observer {
            if (it == true) {
                this.findNavController()
                    .navigate(TodoTaskFragmentDirections.actionSleepQualityFragmentToSleepTrackerFragment())
